...
public class GestaoMenu {
    ...
    public static void criarMenu(String caminhoFicheiro) throws IOException {
        ...
        float PC = Float.parseFloat(scanner.nextLine().replace(",", "."));

        System.out.print("Preço de Venda: ");
        float PV = Float.parseFloat(scanner.nextLine().replace(",", "."));
        ...
        String novaLinha = String.format("%s;%s;%.2f;%.2f;%d;%d;%b",
                nome, categoria, PC, PV, tempoPreparacao, tempoConsumo, estado);
